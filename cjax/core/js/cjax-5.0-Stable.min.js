...
form.submit();CJAX.lib.loadCallback(iframe,function(){response=iframe.contentWindow.document.body.innerHTML;CJAX.process_all(response);if(url){$callback(false);}},'_handleUploads');return iframe;};this.$=function(element_id,v){if(!element_id){return;}
