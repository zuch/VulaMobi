...
function CJAX_FRAMEWORK() {
	...
	*/
	...
	this._handleUploads		=		function(form, url, $callback)
	{
		...
		with(form) {
			method ='POST';
			action = __base__+'/core/file/iframe.php?cjax_iframe=1';
	...
	*/
	...
	this._handleRequestHeaders		=		function(url,args)
	{
		...
		CJAX.HTTP_REQUEST_INSTANCE.setRequestHeader('X-Requested-With', 'CJAX FRAMEW0RK 5.0-Stable');
